        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updatePrizePool('first', parseFloat(e.target.value))}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updatePrizePool('second', parseFloat(e.target.value))}
              className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updatePrizePool('third', parseFloat(e.target.value))}
              className="w-full bg-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>
        </div>
            ...
            {totalPrizePool > 0 && (
              <>
                <div
                  ...
                  style={{ width: `${(formData.prizePool.first / totalPrizePool) * 100}%` }}
                />
                <div
                  className="h-full bg-gray-400"
                  style={{ width: `${(formData.prizePool.second / totalPrizePool) * 100}%` }}
                />
                <div
                  className="h-full bg-amber-600"
                  style={{ width: `${(formData.prizePool.third / totalPrizePool) * 100}%` }}
                />
              </>
            )}
          </div>
