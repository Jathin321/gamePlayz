...
function TournamentPreview({ formData }) {
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden">
      ...
      {/* Content */}
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-2">{formData.name || 'Tournament Name'}</h2>
        ...
        {/* Description */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2">About the Tournament</h3>
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-700/50 rounded-lg p-4 mb-4">
            <p className="font-medium">
              {formData.format.split('-').map(word => 
