...
function ScrimStatus({ formData }) {
  const totalPrizePool = Object.values(formData.prizePool).reduce((a, b) => a + b, 0);

  return (
    <div className="bg-gray-800 rounded-lg p-6 sticky top-24">
      <h2 className="text-xl font-semibold mb-6">Scrim Overview</h2>
      ...
      <div className="space-y-6">
        ...
        {(!formData.name || !formData.gameId || !formData.startDate || !formData.endDate) && (
          <div className="bg-red-500/20 text-red-400 rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              {!formData.name && <li>Scrim name</li>}
              {!formData.gameId && <li>Game selection</li>}
