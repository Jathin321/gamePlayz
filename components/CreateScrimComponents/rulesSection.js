...
function RulesSection({ formData, onUpdate }) {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-6">
      <h2 className="text-xl font-semibold mb-6">Scrim Rules & Matches Count</h2>
      
      <div className="space-y-6">
        {/* Matches Count */}
        <div>
          <label htmlFor="matchesCount" className="block text-sm font-medium text-gray-400 mb-2">
            Matches Count
          </label>
          <input
            type="text"
            ...
            onChange={(e) => onUpdate({ matchesCount: e.target.value })}
