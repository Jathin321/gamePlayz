...
const Teams = () => {
  ...
  const filteredTeams = applySort(
    teams.filter((team) => {
      ...
      // Member count filter
      const meetsMemberCount =
        (team._count?.members || 0) >= filters.minMembers;
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-purple-100 mb-8">
              Connect with competitive players who share your gaming passion and
              goals. Join an existing team or create your own.
            </p>
            <div className="flex gap-4">
              ...
              <button
                onClick={() =>
                  window.scrollTo({
                    top:
                      document.getElementById("team-explorer").offsetTop - 100,
                    behavior: "smooth",
                  })
                }
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-64 space-y-6">
            ...
            <div
              ...
              } bg-gray-800/60 backdrop-blur-sm rounded-xl p-4 lg:p-5 border border-gray-700`}
            >
              <div>
                  ...
                  {gameOptions.map((game) => (
                    ...
                    >
                      <div className="relative flex items-center">
                        ...
                        <Check
                          className={`w-3 h-3 text-white absolute left-1 top-1 transition-opacity ${
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className="relative flex items-center">
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange("recruiting", !filters.recruiting)
                        }
                      />
                      <div className="w-10 h-5 bg-gray-700 rounded-full peer-checked:bg-purple-600 transition-all">
                        <div
                          className={`absolute w-4 h-4 bg-white rounded-full top-0.5 transition-all ${
                            filters.recruiting ? "left-[1.35rem]" : "left-0.5"
                          }`}
                        ></div>
                      </div>
                    </div>
              ...
              {filteredTeams.map((team) => (
                ...
                >
                  <div className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          ...
                          {/* Team age indicator remains unchanged */}
                    ...
                    {/* Requirements Section - Modified to use existing data */}
                    <div className="mb-6 bg-gray-800/50 rounded-lg p-3">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-start gap-2 text-sm text-gray-400">
                          ...
                          <span>Team Size: {team.members.length} members</span>
                        </div>
                        <div className="flex items-start gap-2 text-sm text-gray-400">
                          <div className="w-4 h-4 mt-0.5">❖</div>
                          <span>
                        ...
                        {/* Show join availability based on pending join requests count */}
                        {team._count?.joinRequests < 10 ? (
            ...
            {filteredTeams.length === 0 && (
              <div className="text-center py-20 bg-gray-800/30 rounded-xl border border-gray-700/50 my-12">
                ...
                <p className="text-gray-400 mb-6 max-w-md mx-auto">
                  We couldn't find any teams matching your current filters. Try
                  adjusting your search criteria or create your own team!
                </p>
