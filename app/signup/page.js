      ...
      <div className={classes.formContainer}>
        ...
        <form className={classes.form}>
          ...
          <div className={classes.inputGroup}>
            ...
            <input type="password" name="password" className='mb-2' id="password" />
          </div>
          <button className={classes.sign}>Register</button>
        </form>
        ...
        <p className={classes.signup}>Already having an account?
          <Link href="/login" rel="noopener noreferrer">Log In</Link>
        </p>
      </div>
    </div>
  );
