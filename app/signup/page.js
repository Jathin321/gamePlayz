        ...
        <div className={classes.socialicons}>
          ...
          <button aria-label="Log in with GitHub" className={classes.icon}>
            <svg
              ...
              className="w-5 h-5 fill-current"
            >
              <path d="M16 0.396c-8.839 0-16 7.167-16 16 0 7.073 4.584 13.068 10.937 15.183 0.803 0.151 1.093-0.344 1.093-0.772 0-0.38-0.009-1.385-0.015-2.719-4.453 0.964-5.391-2.151-5.391-2.151-0.729-1.844-1.781-2.339-1.781-2.339-1.448-0.989 0.115-0.968 0.115-0.968 1.604 0.109 2.448 1.645 2.448 1.645 1.427 2.448 3.744 1.74 4.661 1.328 0.14-1.031 0.557-1.74 1.011-2.135-3.552-0.401-7.287-1.776-7.287-7.907 0-1.751 0.62-3.177 1.645-4.297-0.177-0.401-0.719-2.031 0.141-4.235 0 0 1.339-0.427 4.4 1.641 1.281-0.355 2.641-0.532 4-0.541 1.36 0.009 2.719 0.187 4 0.541 3.061-2.059 4.4-1.641 4.4-1.641 0.86 2.205 0.318 3.834 0.141 4.235 1.025 1.12 1.645 2.546 1.645 4.297 0 6.135-3.735 7.507-7.287 7.907 0.571 0.493 1.093 1.503 1.093 2.898 0 2.092-0.009 3.907-0.015 4.358 0 0.429 0.288 0.923 1.093 0.772 6.354-2.116 10.938-8.111 10.938-15.183 0-8.833-7.167-16-16-16z" />
            </svg>
          </button>
        </div>
      </div>
